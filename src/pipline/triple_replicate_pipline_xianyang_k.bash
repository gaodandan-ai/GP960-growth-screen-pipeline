...
python ../data_processing/triple_replicate/03.calculate_fitness.py \
    --input_dir ../../data/results/triple_replicate/xianyang_k/02.cleaned_data \
    --output_dir ../../data/results/triple_replicate/xianyang_k/03.stress_tolerance_analysis \
...
python ../data_processing/triple_replicate/04.plot_gene_od.py \
    --input_dir ../../data/results/triple_replicate/xianyang_k/02.cleaned_data \
    --output_dir ../../data/results/triple_replicate/xianyang_k/04.gene_growth_curves \
    --analysis_dir ../../data/results/triple_replicate/xianyang_k/03.stress_tolerance_analysis \
    --time_max 48.0

## step5: calculate_full_features.py
python ../data_processing/triple_replicate/05.calculate_full_features.py \
    --input_dir ../../data/results/triple_replicate/xianyang_k/02.cleaned_data \
    --output_dir ../../data/results/triple_replicate/xianyang_k/05.full_features
...
python ../data_processing/triple_replicate/06.plot_raw_correlation_heatmap_exact.py \
    --input ../../data/results/triple_replicate/xianyang_k/05.full_features/all_features_raw_50plus.csv \
    --output_dir ../../data/results/triple_replicate/xianyang_k/06.plot_feature_selection

## step7: calculate_rf_matrix.py
python ../data_processing/triple_replicate/07.calculate_rf_matrix.py \
    --input_features ../../data/results/triple_replicate/xianyang_k/05.full_features/all_features_raw_50plus.csv \
    --input_selected ../../data/results/triple_replicate/xianyang_k/06.plot_feature_selection/selected_features_list.csv \
    --output_dir ../../data/results/triple_replicate/xianyang_k/07.select_features_RF

## step8: screen_top5_per_feature.py
python ../data_processing/triple_replicate/08.screen_top5_per_feature.py \
    --input ../../data/results/triple_replicate/xianyang_k/07.select_features_RF/rf_matrix_final.csv \
    --output_dir ../../data/results/triple_replicate/xianyang_k/08.top5_strains \
    --top_n 5

## step9: plot_top_strains_curves.py
python ../data_processing/triple_replicate/09.plot_top_strains_curves.py \
    --input_dir ../../data/results/triple_replicate/xianyang_k/02.cleaned_data \
    --top5_file ../../data/results/triple_replicate/xianyang_k/08.top5_strains/top5_strains_per_feature.csv \
    --output_dir ../../data/results/triple_replicate/xianyang_k/09.plot_top5_curves_by_feature

## step10: plot_dotplot.py
python ../data_processing/triple_replicate/10.plot_dotplot.py \
    --top5_file ../../data/results/triple_replicate/xianyang_k/08.top5_strains/top5_strains_per_feature.csv \
    --output_dir ../../data/results/triple_replicate/xianyang_k/10.dotplot
