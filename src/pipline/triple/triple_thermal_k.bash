...
RESULT_DIR="${BASE_DIR}/data/results/triple_replicate/thermal_k"
...
python ${PROC_DIR}/01.pp_rawdata.py \
    --rawdata_dir ${RAW_DIR}/thermal_k \
    --plate_file ${RAW_DIR}/knockout_plate_gene_mapping.xlsx \
...
python ${PROC_DIR}/02.data_cleaning.py \
    ...
    --mapping_file ${RAW_DIR}/knockout_plate_gene_mapping.xlsx \
    --threshold 1
